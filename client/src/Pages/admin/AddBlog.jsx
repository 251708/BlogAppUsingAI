 ...
 const [loading,setLoading] = useState(false)
  ...
  return (
    ...
    <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
      ...
      <button disabled= {loading} type='button' className='absolute bottom-1 right-2 ml-2 text-xs text-white bg-black/70 px-4 py-1.5 rounded hover:underline cursor-pointer' onClick={generateContent}>Generate with AI</button>
    </div>
