    ...
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        <div className='inline-flex items-center justify-center gap-4 px-6 py-1.5 mb-4 border border-primary/40 bg-primary/10 rounded-full text-sm text-primary'>
            ...
            <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ullam delectus nesciunt dolore, possimus rerum asperiores. Est qui reprehenderit esse </p>
      ...
      <img src={assets.gradientBackground} alt='' className='absolute -top-50 -z-10 opacity-45'/>
    </div>
  )
}
