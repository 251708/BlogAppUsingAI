...
const Login = () => {
  ...
  return (
    ...
    <div className='w-full max-w-sm p-6 max-md:m-6 border border-primary/30 shadow/xl shadow-primary/15 rounded-lg'>
        ...
        <form onSubmit={handleSubmit} className='mt-6 w-full sm:max-w-md type-gray-600'>
            <div className='flex flex-col'>
             ...
             <div className='flex flex-col'>
                ...
                <input onChange={e => setPassword(e.target.value)} value={password} type="password" placeholder='your password'className='order-b-2 border-gray-300 p-2 outline-none mb-6' />
            </div>
